...
var attr_col = ['align','charoff','valign','width']; 
var attr_embed = ['align','hspace','name','vspace']; 
var attr_h1 = ['align']; 
var attr_h2 = attr_h1; 
var attr_h3 = attr_h1; 
var attr_h4 = attr_h1; 
...
var attr_head = ['profile']; 
var attr_hr = ['align','color','noshade','size','width']; 
var attr_html = ['version']; 
var attr_iframe = ['longdesc','datasrc','datafld','align','allowtransparency','frameborder','haspace','marginheight','marginwidth','scrolling','vspace']; 
var attr_img = ['align','border','datasrc','datafld','hspace','longdesc','lowsrc','name','vspace']; 
var attr_input = ['usemap','datasrc','datafield','dataformatas','align','hspace','vspace']; 
var attr_li = ['type']; 
var attr_link = ['charset','methods','rev','urn','target']; 
var attr_meta = ['scheme']; 
var attr_object = ['archive','align','border','classid','code','codebase','codetype','datafld','dataformatas','datasrc','declare','hspace','standby','vspace']; 
var attr_option = ['name','datasrc','dataformatas']; 
var attr_param = ['datafld','type','valuetype']; 
var attr_script = ['event','for','language']; 
var attr_table = ['align','bgcolor','background','cellpadding','cellspacing','datapagesize','frame','rules','summary','width',]; 
var attr_td = ['abbr','align','axis','bgcolor','background','char','charoff','height','nowrap','valign','width']; 
var attr_th = attr_td; 
var attr_tr = attr_td; 
...
function remove_attr(all, attrAr) {
	gAll = document.getElementsByTagName(all); var i = gAll.length; var j;
